...
PACKAGES=$PACKAGES" iputils-ping iproute curl vpnc rsync openssh-server e17"
PACKAGES=$PACKAGES" nodm xserver-xorg-input-evdev xterm xserver-xorg xserver-xorg-video-fbdev"
...
echo adam > $ROOTDIR/etc/hostname
